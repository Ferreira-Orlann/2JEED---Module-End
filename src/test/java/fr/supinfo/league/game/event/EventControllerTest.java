...
public class EventControllerTest {
    ...
    @Test
    public void whenCreateEvent() throws Exception {
        // Given
        ...
        // When
        ResultActions resultActions = this.mockMvc.perform(MockMvcRequestBuilders.post("/games/" + "ac05477e-60e0-4c07-9455-6929c1b4c169" + "/events").content(body)
